...
Posterno component that provides support for the official addons.

## Installation

This is a development repository for the component and requires no installation for production sites because it's integrated within Posterno's core plugin.
