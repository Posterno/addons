...
class Page {
	...
	public function admin_menu() {
		add_submenu_page( 'edit.php?post_type=listings', esc_html__( 'Posterno Extensions', 'posterno' ), '<span class="dashicons dashicons-star-filled" style="font-size: 17px"></span> ' . esc_html__( 'Add-ons', 'posterno' ), 'manage_options', 'posterno-addons', [ $this, 'display' ] );
	}
